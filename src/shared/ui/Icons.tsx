...
export function IconShare() {
  return (
    ...
    >
      ...
      <path
        d="M4.5 7.2l7-3.2M4.5 8.8l7 3.2"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
...
export function RatingIconFilled({ className }: { className?: string } = {}) {
  return (
    <svg
      width="16"
      height="16"
...
export function RatingIconOutline({ className }: { className?: string } = {}) {
  return (
    <svg
      width="16"
      height="16"
