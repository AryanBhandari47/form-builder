    ...
    <div className="flex flex-col gap-1.5 w-full">
      ...
      <div
        className={cn(
          ...
          hasError ? "border-red" : "border-border hover:border-text-muted"
        )}
      >
        {prefix && (
          <span className="pl-3 shrink-0 text-text-muted">{prefix}</span>
        )}
        ...
        {suffix && (
          <span className="pr-3 shrink-0 text-text-muted">{suffix}</span>
        )}
      </div>
