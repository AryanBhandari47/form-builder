    ...
    return (
      ...
      >
        <div className="flex-1 flex flex-col items-center justify-center px-6 text-center">
          <div className="w-12 h-12 rounded-[var(--radius-lg)] bg-sidebar border border-border flex items-center justify-center mb-3">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden="true" className="text-text-muted">
          ...
          <h3 className="text-sm font-semibold text-text-primary mb-1">No field selected</h3>
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4">
        ...
        {activeTab === 'conditions' && (
          <ConditionsBuilder templateId={templateId} fieldId={selectedField.id} />
        )}
      </div>
    </aside>
  )
