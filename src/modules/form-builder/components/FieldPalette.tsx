...
import { getAllFieldEntries } from "@/modules/field-registry";
import {
  setSelectedField,
  setDirty,
  setSearchQuery,
...
export function FieldPalette({ templateId }: FieldPaletteProps) {
  ...
  const allEntries = React.useMemo(() => getAllFieldEntries(), []);
            ...
            <div key={cat} className="mb-1">
              ...
              {entries.map((entry) => (
                ...
                >
                  ...
                  {/* Icon */}
                  <span className="flex-shrink-0 text-text-secondary group-hover:text-primary transition-colors">
